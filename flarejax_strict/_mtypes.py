import dataclasses
import functools
from typing import Callable, Hashable, Mapping, Self, TypeVar, Generic

import jax

from ._config import ConfigMapping, is_valid_conifg_type, ConfigSequence
...
M = TypeVar(
    "M",
    bound=None | bool | int | float | str | ConfigMapping | ConfigSequence | Module,
)
